...
def randomNumber():
    ...
    '''
    toReturn = 0
    toReturn = int(random.randint(1000,9999))
    return toReturn
...
def listUntil(a):
    ...
    '''
    toReturn = []
    #looked through all the websites and did some googling myself and couldnt figure out how to do this
    return toReturn
